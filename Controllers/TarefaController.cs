...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            //Busca as tarefas no banco que contenha o titulo recebido por parâmetro
        ...
        {
            //Busca as tarefas no banco que contenha o status recebido por parâmetro
        ...
        public IActionResult Criar(Tarefa tarefa)
        {
            ...
            //Adiciona a tarefa recebida e salva as mudanças
            _context.Add(tarefa);
        ...
        public IActionResult Atualizar(int id, Tarefa tarefa)
        {
            ...
            //Atualiza a variável tarefaBanco e salva as mudanças
